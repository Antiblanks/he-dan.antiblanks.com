...
A SMART plan is not something that is new to me as I do, although not formally documenting it, regularly adopt this approach with my business partner when analysing the current direction of our company [Antiblanks](http://www.antiblanks.com) in order to devise time based plans and objectives that help us with our decision making.
...
My main goal throughout this course, other than to gain the accreditation of course, is to exit with at least one Intellectual Property (IP) that we can further and bring to market at [Antiblanks](http://www.antiblanks.com). I want the course to help reignite my creativity and identify a really strong idea, that I can then apply my years of industry experience to and make a success of it.
